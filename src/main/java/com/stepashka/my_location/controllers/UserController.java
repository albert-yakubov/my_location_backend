...
import com.stepashka.my_location.handlers.RestExceptionHandler;
...
public class UserController
{
    ...
    // http://localhost:0122/users/users/?page=1&size=1
    // http://localhost:0122/users/users/?sort=username,desc&sort=<field>,asc
    // http://localhost:0122/users/users
    ...
    // http://localhost:0122/users/allusers
    ...
    // http://localhost:0122/users/user/7
    ...
    // http://localhost:0122/users/user/name/cinnamon
    ...
    // http://localhost:0122/users/user
    /*
            {
                "username": "Mojo",
...
*/
    ...
    // http://localhost:0122/users/user/14
    ...
    // http://localhost:0122/users/user/7/role/2
    ...
    // http://localhost:0122/users/user/15/role/2
    ...
    // http://localhost:0122/users/user/email/count
